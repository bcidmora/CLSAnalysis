...
def PlotSingleHadronsFits(the_single_fit_data, the_type_fit, the_nr_exps, the_tmins, the_version, the_location, the_rebin, the_irreps, **kwargs):    
    ...
    for the_irrep in s_irreps:
        ...
        # the_nt_ticks = np.arange(the_nt[0], the_nt[-1], 3)
...
#         NameIrrepPlot = da_irrep.NamePlot
        ...
        # vf.PLOT_FITS(the_nt, the_fit_data, the_fit_sigmas, the_chosen_tmin, the_label, r'${t_{\mathrm{min}}/\,a}$', r'$a \; E_{\mathrm{lab}}$', OperatorNamePlot + ' (%s): '%MomentumIrrep + r' $\to$ %s '%NameIrrepPlot + '(%s-exp)'%the_nr_exps, the_nt_ticks)
        # plt.show()
        ...
        vfp.PLOT_FITS(the_nt, the_fit_data, the_fit_sigmas, the_chosen_tmin, the_label, r'${t_{\mathrm{min}}/\,a}$', r'$a \; E_{\mathrm{lab}}$', OperatorNamePlot +  ' (%s-exp)'%the_nr_exps, the_nt_ticks)
        plt.show()
        ...
        if the_zoom_flag: 
            ...
            zoom_fit_fig = plt.figure(figsize=(5.5,4.5))
            vfp.PLOT_FITS(the_nt, the_fit_data, the_fit_sigmas, the_chosen_tmin, the_label, r'${t_{\mathrm{min}}}$', r'$a_{t} \; E_{\mathrm{lab}}$', OperatorNamePlot + ' (%s): '%MomentumIrrep + r' $\to$ %s '%NameIrrepPlot + '(%s-exp)'%the_nr_exps, the_nt_ticks, zoom=True, the_ll =3, the_ul=4)
            # plt.show()
        ...
        if the_chi_plots_flag:
            ...
            chi_fig = plt.figure(figsize=(5.5,4.5))
            ...
            vfp.PLOT_FITS(the_nt, the_chi_corr, the_chi_sigmas, the_chosen_tmin, the_label, r'${t_{\mathrm{min}}}\,/\,a$', r'$\chi^{2}/\mathrm{d.o.f} $', OperatorNamePlot + ' (%s-exp)'%the_nr_exps, the_nt_ticks)
            plt.show()
        ...
        if the_chi_plots_flag and the_zoom_flag:
            ...
            chi_fig = plt.figure()
            vfp.PLOT_FITS(the_nt, the_chi_corr, the_chi_sigmas, the_chosen_tmin, the_label, r'${t_{\mathrm{min}}}$', r'$\chi^{2}/\mathrm{d.o.f} $', OperatorNamePlot + ' (%s): '%MomentumIrrep + r' $\to$ %s'%NameIrrepPlot + '(%s-exp)'%the_nr_exps, the_nt_ticks, zoom=True, the_ll=3, the_ul=4)
            # plt.show()
            chi_fig.savefig(f'{the_location}Tmin_Chisqr_{the_irrep[:4]}_{the_irrep[-1]}_{the_nr_exps}exp{the_rebin}_{the_version}.pdf', bbox_inches='tight')
        ...
        if the_total_chi_flag:
            ...
            vfp.PLOT_CHI_FITS(the_nt, total_chi, the_chosen_tmin, the_label, r'${t_{\mathrm{min}}}$', r'$\chi^{2}$', OperatorNamePlot + ' (%s): '%MomentumIrrep + r' $\to$ %s'%NameIrrepPlot + '(%s-exp)'%the_nr_exps, the_nt_ticks)
        ...
        if the_delta_chi_flag:
            ...
            vfp.PLOT_CHI_FITS(the_nt[:-1], delta_chis, the_chosen_tmin, r'$\Delta\chi^{2} = \chi^{2}({t}) - \chi^{2}({t}+1)$', r'${t_{\mathrm{min}}}$', r'$\Delta\chi^{2}$', OperatorNamePlot + ' (%s): '%MomentumIrrep + r' $\to$ %s'%NameIrrepPlot + '(%s-exp)'%the_nr_exps, the_nt_ticks)
        ...
        if the_all_fits_flag:
            ...
            print("All the fits available are: ", the_fits_avail)
            
            the_colors_list  = [ "#5d83d5", "#b90f22", "#ffa500"]
            the_markers_list = ['o','^','s']
            
            ### The SH operator that appears in the plot
            the_op = list(the_single_fit_data[the_irrep+'/Operators'])[0]
            theOperatorNamePlot = vf.OPERATORS_SH(the_op.decode('utf-8'))
            ...
            OperatorNamePlot = vf.SH_OPERATORS_RELABEL(theOperatorNamePlot, NameIrrepPlot, nrMomentumIrrep )
            
            a_counter = 0
            fig_all = plt.figure(figsize=(5.5,4.5))
            for the_fit in the_fits_avail:
                
                print(the_fit)
                ### This is the info of the fits for this irrep
                dis_set =  np.array(the_single_fit_data[the_irrep + '/%s'%the_fit + '/Tmin/%s/Mean'%the_type_fit])
...
#                 the_chosen_tmin = the_nt.index(the_tmins[the_irreps.index(the_irrep)])
                ...
                if '1' in the_fit: 
                    ...
                    the_color_1 = the_colors_list[0]
                    the_marker_1 = the_markers_list[0]
                elif '2' in the_fit: 
                    the_label = "Double exponential"
                    the_only_data = [the_nt, the_fit_data, the_fit_sigmas]
                    the_color_1 = the_colors_list[1]
                    the_marker_1 = the_markers_list[1]
                elif 'g' in the_fit: the_label = "Geometric series"

                plt.errorbar(the_nt, the_fit_data, yerr= the_fit_sigmas, marker=the_markers_list[a_counter], ls='None', ms=6, markeredgewidth=1.75, lw=1.75, elinewidth=1.75, zorder=3, capsize=6, label = the_label, color = the_colors_list[a_counter])
                
                
                # plt.errorbar([the_nt[the_chosen_tmin]], [the_fit_data[the_chosen_tmin]], yerr= [the_fit_sigmas[the_chosen_tmin]], marker=the_markers_list[a_counter], ls='None', ms=8, markeredgewidth=1.75, lw=1.75, elinewidth=1.75, zorder=3, capsize=6, color = the_colors_list[a_counter], markerfacecolor='white')
                
                a_counter+=1
            
            plt.errorbar([the_only_data[0][the_chosen_tmin]], [the_only_data[1][the_chosen_tmin]], yerr= [the_only_data[2][the_chosen_tmin]], marker=the_marker_1, ls='None', ms=8, markeredgewidth=1.75, lw=1.75, elinewidth=1.75, zorder=3, capsize=6, color = the_color_1, markerfacecolor='white')
            ...
            plt.tight_layout()
            plt.show()
            fig_all.savefig(the_location + 'Different_Fits_' + the_irrep[:4] +'_%s'%the_irrep[-1] +'_'+ the_rebin + '_v%s.pdf'%the_version, bbox_inches='tight')
            # vf.PLOT_FITS(the_nt, the_fit_data, the_fit_sigmas, the_chosen_tmin, the_label, r'${t_{\mathrm{min}}}$', r'$a_{t} \; E_{\mathrm{lab}}$', OperatorNamePlot + ' (%s): '%MomentumIrrep + r' $\to$ %s '%NameIrrepPlot + '(%s-exp)'%the_nr_exps, the_nt_ticks)
        ...
        if '%sexp'%the_nr_exps in list(the_multi_hadrons_fit_data[the_irrep].keys()) and kwargs.get('gevp')==True: 
            ...
            for bb in range(len(list(the_data.keys()))):
                ...
                if the_zoom_flag:
                    ...
                    fit_fig = plt.figure()
                    vf.PLOT_FITS(the_nt, the_fit_data, the_fit_sigmas, the_chosen_tmin, the_label, r'$t_{\mathrm{min}}$', r'$a_{t} \;\Delta E$',  NameIrrepPlot+ ' (%s): '%MomentumIrrep + r' $\to \;\lambda_{%s}$'%str(bb)  + r' ($t_{0} = %s$)'%str(the_t0), the_nt_ticks, zoom=True, the_ll=2, the_ul =5)
                    # plt.show()
                    fit_fig.savefig(the_location + 'Tmin_Fits_Zoom' + the_quantum_number + the_irrep + '_%s'%str(bb) + '_t0_%s'%str(the_t0) + '_%sexp'%the_nr_exps + the_rebin + '_v%s.pdf'%the_version, bbox_inches='tight')
                ...
                if the_chi_plots_flag and the_zoom_flag:
                    ...
                    vf.PLOT_FITS(the_nt, the_chi_corr, the_chi_sigmas, the_chosen_tmin, the_label, r'$t_{\mathrm{min}}\,/\,a$', r'$\chi^{2}/\mathrm{d.o.f} $',  NameIrrepPlot+ ' (%s): '%MomentumIrrep + r' $\to \;\lambda_{%s}$'%bb + r' ($t_{0} = %s$)'%str(the_t0), the_nt_ticks, zoom=True, the_ll=2, the_ul =5)
                    # plt.show()
                    zoom_fit_fig.savefig(the_location + 'Tmin_Chisqr_Zoom' + the_quantum_number + the_irrep + '_%s'%str(bb) + '_t0_%s'%str(the_t0) + '_%sexp'%the_nr_exps + the_rebin + '_v%s.pdf'%the_version, bbox_inches='tight')
                ...
                if the_total_chi_flag:
                    ...
                    plt.tight_layout()
                    # plt.show()
                    total_chi_fig.savefig(the_location + 'Tmin_TotalChisqr' + the_quantum_number + the_irrep +'_%s'%str(bb) + '_t0_%s'%str(the_t0) + '_%sexp'%the_nr_exps + the_rebin + '_v%s.pdf'%the_version, bbox_inches='tight')                
                ...
                if the_delta_chi_flag:
                    ...
                    plt.tight_layout()
                    # plt.show()
                    delta_chi_fig.savefig(the_location + 'Tmin_DeltaChisqr' + the_quantum_number + the_irrep + '_%s'%str(bb) + '_t0_%s'%str(the_t0) + '_%sexp'%the_nr_exps + the_rebin + '_v%s.pdf'%the_version, bbox_inches='tight')
                ...
                if len(the_t0_data)>2:
                    ...
                    plt.tight_layout()
                    #plt.show()
                    t0s_fig.savefig(the_location + 'T0s' + the_quantum_number + the_irrep + '_%s'%str(bb) + '_%sexp'%the_nr_exps + the_rebin + '_v%s.pdf'%the_version, bbox_inches='tight')
        ...
        if 'Operators_Analysis' in list(the_multi_hadrons_fit_data[the_irrep].keys()) and the_ops_analysis_flag:
            ...
            for the_op_item in the_list_of_chosen_ops:
                ...
                for bb in range(len(list(the_data.keys()))):
                    ...
                    vf.PLOT_FITS(the_nt, the_fit_data, the_fit_sigmas, the_chosen_tmin, the_label, r'$t_{\mathrm{min}}$', r'$a_{t} \;\Delta E$',  NameIrrepPlot+ ' (%s): '%MomentumIrrep + r' $\to \;\lambda_{%s}$'%str(bb)  + r' ($t_{0} = %s$)'%str(the_t0), the_nt_ticks)
                    # plt.show()
                    fit_fig.savefig(the_location + 'Tmin_Fits' + the_quantum_number + the_op_item + '_' + the_irrep + '_%s'%str(bb) + '_t0_%s'%str(the_t0)  + '_%sexp'%the_nr_exps + the_rebin + '_v%s.pdf'%the_version, bbox_inches='tight')
                    ...
                    if the_zoom_flag:
                        ...
                        vf.PLOT_FITS(the_nt, the_fit_data, the_fit_sigmas, the_chosen_tmin, the_label, r'$t_{\mathrm{min}}$', r'$a_{t} \;\Delta E$',  NameIrrepPlot+ ' (%s): '%MomentumIrrep + r' $\to \;\lambda_{%s}$'%str(bb)  + r' ($t_{0} = %s$)'%str(the_t0), the_nt_ticks, zoom=True, the_ll=2, the_ul =5)
                        # plt.show()
                        fit_fig.savefig(the_location + 'Tmin_Fits_Zoom' + the_quantum_number + the_op_item + '_' + the_irrep + '_%s'%str(bb) + '_t0_%s'%str(the_t0) + '_%sexp'%the_nr_exps + the_rebin + '_v%s.pdf'%the_version, bbox_inches='tight')
                    ...
                    if the_chi_plots_flag:
                        ...
                        # plt.show()
                        chi_fit_fig.savefig(the_location + 'Tmin_Chisqr' + the_quantum_number + the_op_item + '_' + the_irrep + '_%s'%str(bb) + '_t0_%s'%str(the_t0) + '_%sexp'%the_nr_exps + the_rebin + '_v%s.pdf'%the_version, bbox_inches='tight')
                    ...
                    if the_chi_plots_flag and the_zoom_flag:
                        ...
                        vf.PLOT_FITS(the_nt, the_chi_corr, the_chi_sigmas, the_chosen_tmin, the_label, r'$t_{\mathrm{min}}$', r'$\chi^{2}/\mathrm{d.o.f} $',  NameIrrepPlot+ ' (%s): '%MomentumIrrep + r' $\to \;\lambda_{%s}$'%bb + r' ($t_{0} = %s$)'%str(the_t0), the_nt_ticks, zoom=True, the_ll=2, the_ul =5)
                        # plt.show()
                        zoom_fit_fig.savefig(the_location + 'Tmin_Chisqr_Zoom' + the_quantum_number + the_op_item + '_' +  the_irrep + '_%s'%str(bb) + '_t0_%s'%str(the_t0) + '_%sexp'%the_nr_exps + the_rebin + '_v%s.pdf'%the_version, bbox_inches='tight')
                    ...
                    if the_total_chi_flag:
                        ...
                        plt.tight_layout()
                        # plt.show()
                        total_chi_fig.savefig(the_location + 'Tmin_TotalChisqr' + the_quantum_number + the_op_item + '_' +  the_irrep +'_%s'%str(bb) + '_t0_%s'%str(the_t0) + '_%sexp'%the_nr_exps + the_rebin + '_v%s.pdf'%the_version, bbox_inches='tight')                
                    ...
                    if the_delta_chi_flag:
                        ...
                        plt.tight_layout()
                        # plt.show()
                        delta_chi_fig.savefig(the_location + 'Tmin_DeltaChisqr' + the_quantum_number + the_op_item + '_' +  the_irrep + '_%s'%str(bb) + '_t0_%s'%str(the_t0) + '_%sexp'%the_nr_exps + the_rebin + '_v%s.pdf'%the_version, bbox_inches='tight')
                    ...
                    if len(the_t0_data)>2:
                        ...
                        plt.tight_layout()
                        #plt.show()
                        t0s_fig.savefig(the_location + 'T0s' + the_quantum_number + the_op_item + '_' + the_irrep + '_%s'%str(bb) + '_%sexp'%the_nr_exps + the_rebin + '_v%s.pdf'%the_version)
